...
function SecondJeu() {
  ...
  useEffect(() => {
    if (gameOver) return;
    const interval = setInterval(() => deplacerPiece(0, 1), 200); // déplace la pièce vers le bas toutes les 200ms
      ...
      <section className="jeu-et-point">
        <section className="profil-joueur">
          <section className="règles">
            <p>
              Hello, ce niveau est à l'image de la vie, c'est donc très
              compliqué, bonne chance !
            </p>
          </section>
